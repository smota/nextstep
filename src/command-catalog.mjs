...
export const COMMAND_CONTRACTS = Object.freeze({
  ...
  'application-attempt register-package': mutation([], { records: { type: 'object', properties: { company: { type: 'object' }, opportunity: { type: 'object' }, applicationAttempt: { type: 'object' } } }, artifacts: { type: 'array', items: { type: 'object' } } }, ['Creates only missing records and registers existing contained files atomically; drafting remains external.']),
